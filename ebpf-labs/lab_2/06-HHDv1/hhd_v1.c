...
/* TODO 2: Define the struct containing the map value
 * Hint: this is the same struct that is defined in the eBPF program
*/
...
int load_maps_config(const char *config_file, struct hhd_v1_bpf *skel) {
    ...
    /* TODO 1: Get file descriptor of the map that will contain the threshold */

    /* TODO 3: Check if the file descriptor is valid */

    /* TODO 4: Load the IPs and threshold in the BPF map 
     * Hint: you can use the same for loop as before
    */
